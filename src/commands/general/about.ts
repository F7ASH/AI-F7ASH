...
import { fetchTotalCachedGuilds, fetchTotalCachedUsers } from "../../classes/Sharder";
...
export class AboutCommand extends HibikiCommand {
  ...
  public async run(interaction: CommandInteraction) {
    ...
    const userCount = await fetchTotalCachedUsers(this.bot.shard);
      ...
      embeds: [
        {
          ...
          description: interaction.getLocaleString("general.COMMAND_ABOUT_DESCRIPTION", { username: this.bot.user?.username }),
